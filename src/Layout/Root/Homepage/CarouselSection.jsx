    ...
    return (
        <div className='space-y-10'>
            <Heading
                ...
                subTitle='Where Most Of The Traveler Explore Most'
            />
            ...
            <Carousel autoplay>
                <div className="relative w-full h-[500px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-l from-black/50 to-transparent">
                        <div className="absolute bottom-5 md:bottom-10 md:right-5 text-white md:w-[500px] space-y-3 px-5 md:px-0">
                            <h1 className="text-3xl md: font-semibold">Rural Bangladesh</h1>
                ...
                <div className="relative w-full h-[500px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent">
                        <div className="absolute bottom-5 md:bottom-10 md:left-5 text-white md:w-[500px] space-y-3 px-5 md:px-0">
                            <h1 className="text-3xl md: font-semibold">Saint Martin Island</h1>
                ...
                <div className="relative w-full h-[500px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent">
                        <div className="absolute bottom-5 md:bottom-10 md:right-5 text-white md:w-[500px] space-y-3 px-5 md:px-0">
                            <h1 className="text-3xl md: font-semibold">Ahsan Monzil</h1>
                ...
                <div className="relative w-full h-[500px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent">
                        <div className="absolute bottom-5 md:bottom-10 md:left-5 text-white md:w-[500px] space-y-3 px-5 md:px-0">
                            <h1 className="text-3xl md: font-semibold">Sajek Valley</h1>
                ...
                <div className="relative w-full h-[500px]">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent">
                        <div className="absolute bottom-5 md:bottom-10 md:right-5 text-white md:w-[500px] space-y-3 px-5 md:px-0">
                            <h1 className="text-3xl md:text-5xl font-semibold">Saat Gambuj Mosque</h1>
